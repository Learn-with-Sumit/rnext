...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/how-state-works-in-react-a-deep-dive" target="_blank" >REACTIVE ACCELERATOR - MODULE 2 - LESSON 4</a></h3>
</p>
...
In this video, you will learn how to use the useState hook in your vanilla JavaScript code. This will provide you with a clear understanding of how React manages its state and how it behaves when the state is updated. By watching this video attentively and practicing until you can grasp the full concept, you won't encounter any difficulties in dealing with React's useState hook and rendering patterns.
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 2.4
   ```sh
   git checkout 2.4
   ```
