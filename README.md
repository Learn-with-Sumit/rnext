...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/rendering-lists" target="_blank" >REACTIVE ACCELERATOR - MODULE 1 - LESSON 10</a></h3>
</p>
...
This tutorial will show you how to use React to render data from arrays. Learn how to efficiently display dynamic content by mapping through arrays, as well as how to filter arrays to highlight select objects. This tutorial also underlines the significance of utilizing keys to keep lists in order while rendering them. Dive into real-world examples that exemplify these concepts, allowing you to create dynamic and well-organized React components.
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 1.10
   ```sh
   git checkout 1.10
   ```
