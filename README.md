...
✓ প্রোপার্টির ডিটেইলস পেজে প্রোপার্টির নাম, প্রোপার্টিটি কে তৈরি করেছে, এভারেজ রেটিং, কতগুলো রেটিং/রিভিউ রয়েছে তার সংখ্যা, প্রোপার্টির ঠিকানা, ৫ টি ছবি সহ বেশ কিছু তথ্য দেখাতে হবে ।

✓ প্রোপার্টির ডিটেইলস পেজের সকল তথ্য আপনাকে ডেটাবেজ থেকে নিয়ে এসে দেখাতে হবে । এবং এই পেজও সার্ভার থেকে রেন্ডার করে দেখাতে হবে । 

✓ প্রোপার্টির ডিটেইলস পেজের Meta Information গুলো সঠিক ভাবে আপডেটেড থাকতে হবে, যেন যেকোনো ডিটেইলস পেজের লিংক সোশ্যাল মিডিয়াতে শেয়ার করলে, সেই পেজের সঠিক তথ্য সেখানে প্রিভিউ তে দেখা যায়।
...
- Unsplash এর Image URL ব্যবহার করে আর Next.config.js এ unsplash er Domain WhiteList করে দিতে হবে।
- সবাই অন্তত ১০ টা প্রোডাক্ট এড করে রাখবেন ডেটাবেজে । সেই সাথে, কিছু Dummy User তৈরি করে তাদের ইমেইল এবং পাসওয়ার্ড গিটহাবের readme.md তে এড করে রাখবেন।
