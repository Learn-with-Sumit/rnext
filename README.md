...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/thinking-about-ui-declaratively-in-react-finding-visual-states" target="_blank" >REACTIVE ACCELERATOR - MODULE 3 - LESSON 2</a></h3>
</p>
...
Learn how to use React State's power to respond to user interaction by recognizing and maintaining multiple visual states within your components. Learn how to successfully define triggers for state changes in order to create a responsive and dynamic user interface in this course. Practical examples will walk you through the process, ensuring that your React components adapt to user interactions effortlessly.
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 3.2
   ```sh
   git checkout 3.2
   ```
