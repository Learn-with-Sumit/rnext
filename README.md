...
In this video, we'll start our first React project, a Tic-Tac-Toe game. Watch the video and then practice on your own. If you run into problems, get help from the support group. If you want to get the code, follow the steps below.
