...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/thinking-about-ui-declaratively-in-react-finalize-react-states-and-connect-event-handlers" target="_blank" >REACTIVE ACCELERATOR - MODULE 3 - LESSON 3</a></h3>
</p>
...
In this tutorial, you will learn how to React to Input with State by properly expressing the state in memory using useState. Learn how to simplify your state variables by deleting any that aren't required. Connect event handlers to create a responsive and controlled user interface by smoothly setting and managing state.
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 3.3
   ```sh
   git checkout 3.3
   ```
