...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/resetting-state-at-the-same-position-changing-default-behavior" target="_blank" >REACTIVE ACCELERATOR - MODULE 3 - LESSON 11</a></h3>
</p>
...
Explore the complexities of state management with our tutorial "Preserving and Resetting React State: Understanding Exact resets." We walk you through complex methods for preserving essential data while getting precision resets at the same point within your React components in this comprehensive video.
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 3.11
   ```sh
   git checkout 3.11
   ```
