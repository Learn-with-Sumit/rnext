...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/understanding-react-virtual-dom-concept" target="_blank" >REACTIVE ACCELERATOR - MODULE 1 - LESSON 3</a></h3>
</p>
...
This tutorial goes into the heart of React's efficiency with the Virtual DOM. Learn how React uses a virtual version of the DOM to optimize rendering. Understand the concept of a Virtual DOM and how it improves React application speed by reducing actual DOM manipulations. The benefits and implementation of React's Virtual DOM will be demonstrated via practical examples.
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 1.3
   ```sh
   git checkout 1.3
   ```
