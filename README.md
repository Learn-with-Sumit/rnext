...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/reactive-accelerator-course-intro" target="_blank" >REACTIVE ACCELERATOR - MODULE 11 - LESSON 6</a></h3>
</p>
...
In this lesson, we learned how to display a list of posts, highlight the latest post, and design engaging post cards. We covered how to fetch and render post data dynamically in our Next.js project. To practice and see how it all works, you can clone our repository and explore the implementation yourself.
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 11.6
   ```sh
   git checkout 11.6
   ```
