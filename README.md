...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/preserving-and-resetting-state-default-behavior" target="_blank" >REACTIVE ACCELERATOR - MODULE 3 - LESSON 10</a></h3>
</p>
...
With our latest tutorial, "Preserving and Resetting State," you will discover the key to successful state management in your React apps. In this informative video, we look at practical ways for preserving state between components and providing a consistent user experience.
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 3.10
   ```sh
   git checkout 3.10
   ```
