...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/context-passes-through-intermediate-components-3W1EEfjtA" target="_blank" >REACTIVE ACCELERATOR - MODULE 3 - LESSON 18</a></h3>
</p>
...
In this video, we look into how React Context allows for effective data sharing throughout the component tree by passing through intermediary components with ease. Look at how beautifully context propagation works even in non-consuming components. See the codebase download procedure in the attachment below, and for more further information, click the documentation links in the reference section.
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 3.18
   ```sh
   git checkout 3.18
   ```
