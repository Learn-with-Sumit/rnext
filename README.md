...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/choosing-the-state-structure-avoid-duplication-in-state" target="_blank" >REACTIVE ACCELERATOR - MODULE 3 - LESSON 7</a></h3>
</p>
...
In this tutorial, we'll look at the critical topic of choosing the correct React state structure, with a focus on avoiding duplication. Learn how to remove unnecessary repetition in your React components to develop a more streamlined and efficient state management system.
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 3.7
   ```sh
   git checkout 3.7
   ```
