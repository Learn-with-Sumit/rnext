...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/reactive-accelerator-course-intro" target="_blank" >REACTIVE ACCELERATOR - MODULE 5 - LESSON 8</a></h3>
</p>
...
In this tutorial, you will learn how to seamlessly integrate authentication in React with Firebase. Learn how to use Firebase Authentication to build secure user authentication and authorization in your React applications. Follow these step-by-step instructions to easily configure Firebase Authentication, handle user sign-in/sign-up procedures, and manage user sessions. Discover practical examples and recommended practices for improving the security and user experience of your React applications. To gain hands-on experience with authentication in React with Firebase, download the attached codebase and examine the extra material in the reference section.
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 5.8
   ```sh
   git checkout 5.8
   ```
