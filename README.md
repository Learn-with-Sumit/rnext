...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/reactive-accelerator-course-intro" target="_blank" >REACTIVE ACCELERATOR - MODULE 5 - LESSON 4</a></h3>
</p>
...
In this crash course, you will learn about React Hook Form, a powerful toolkit for creating forms in React that is both simple and efficient. Learn how to quickly design and manage forms with React Hook Form's straightforward API, which handles validation, submission, and state management seamlessly. Follow along with real examples and excellent practices to simplify the form-building process. To gain hands-on experience, download the attached codebase and review the supplementary documentation in the reference section to master React Hook Form and expedite your development workflow.
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 5.4
   ```sh
   git checkout 5.4
   ```
