...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/importing-and-exporting-components" target="_blank" >REACTIVE ACCELERATOR - MODULE 1 - LESSON 5</a></h3>
</p>
...
Explore the ins and outs of importing and exporting React components in this tutorial. Gain a solid understanding of how to integrate external components into your React projects and effectively share them across different parts of your application. Follow the attached guide to download the codebase featured in the video, allowing you to implement these techniques in your own projects effortlessly.
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 1.5
   ```sh
   git checkout 1.5
   ```
