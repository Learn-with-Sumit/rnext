...
✓ আপনার Debounce Technique Implement করতে হবে সার্চের ক্ষেত্রে । যদি এটি সম্পর্কে না জেনে থাকেন তাবে এই ভিডিও দেখে শিখে নিতে পারেন - [Debounce Function in JavaScript](https://youtu.be/dD9O8DnIBj4)

✓ বই গুলো নাম এবং পাবলিশ এর সালের উপর ভিত্তি করে Sort করা যাবে । Sort করার জন্যে বই এর লিস্টের উপরে ডান পাশে Dropdown আছে, সেটি পরিবর্তন করলেই বই গুলো Sort করবে । 
