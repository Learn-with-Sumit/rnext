...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/using-and-providing-context-from-the-same-component-g1hDa1k_M" target="_blank" >REACTIVE ACCELERATOR - MODULE 3 - LESSON 17</a></h3>
</p>
...
In this lesson, we'll look at a great strategy for streamlining the data flow in your React application. Investigate the art of using and giving context straight from the same component, providing a succinct and efficient approach to managing shared state.
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 3.17
   ```sh
   git checkout 3.17
   ```
