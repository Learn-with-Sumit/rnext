...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/reactive-accelerator-course-intro" target="_blank" >REACTIVE ACCELERATOR - MODULE 11 - LESSON 7</a></h3>
</p>
...
In this lesson, we explored how to create a detailed view for individual posts. We covered fetching and displaying post-specific information dynamically in our Next.js project. If you want to try building this feature, you can clone our repository and experiment with the setup and code.
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 11.7
   ```sh
   git checkout 11.7
   ```
