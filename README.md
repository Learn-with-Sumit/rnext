...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/updating-arrays-in-a-state" target="_blank" >REACTIVE ACCELERATOR - MODULE 2 - LESSON 9</a></h3>
</p>
...
This extensive tutorial delves into the complexities of updating arrays in React state. Learn efficient methods for changing and managing array state in your React components. Through realistic examples, you'll learn how to update array data in real time, ensuring the responsiveness and flexibility of your React apps.
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 2.9
   ```sh
   git checkout 2.9
   ```
