...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/reactive-accelerator-course-intro" target="_blank" >REACTIVE ACCELERATOR - MODULE 5 - LESSON 5</a></h3>
</p>
...
Master React error handling with Suspense & Error Boundaries. Manage loading states & gracefully handle errors with practical examples & best practices. Dive in & enhance your React apps!
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 5.5
   ```sh
   git checkout 5.5
   ```
