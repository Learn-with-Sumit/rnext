...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/reactive-accelerator-course-intro" target="_blank" >REACTIVE ACCELERATOR - MODULE 2 - LESSON 8</a></h3>
</p>
...
| ---------------------------- | -------------------------- | -------------------------- |
| [Get Template](#-get-template) | [How to run](#-how-to-run) | [Contact us](#-contact-us) |

<br>

<!-- GET HTML TEMPLATE -->

## ![htmlIcon][htmlicon-shield] Get Template
...
6. In the dist folder you will get html files. You can open them by simply double clicking or Just run the index.html file with Visual Studio Code [Live Server plugin](https://marketplace.visualstudio.com/items?itemName=ritwickdey.LiveServer).
