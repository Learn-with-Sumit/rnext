...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/conditional-rendering" target="_blank" >REACTIVE ACCELERATOR - MODULE 1 - LESSON 9</a></h3>
</p>
...
Learn the magic of React Conditional Rendering with our comprehensive guide. Learn how to construct responsive and adaptive user interfaces by dynamically rendering components based on situations. This lesson walks you through real-world examples of how to utilize conditional statements to control the display and content of React components.
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 1.9
   ```sh
   git checkout 1.9
   ```
