...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/writing-concise-reducers-with-immer" target="_blank" >REACTIVE ACCELERATOR - MODULE 3 - LESSON 15</a></h3>
</p>
...
Improve your React state management with our latest tutorial. In this detailed guide, we will look at the capabilities of Immer, a library that streamlines the process of changing state within reducers, allowing you to create more concise and expressive code.
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 3.15
   ```sh
   git checkout 3.15
   ```
