...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/passing-data-deeply-with-context-introduction-to-context-api" target="_blank" >REACTIVE ACCELERATOR - MODULE 3 - LESSON 16</a></h3>
</p>
...
Discover the potential of seamless data sharing in React as we look at "Passing Data Deeply with React Context" in this detailed tutorial. Learn how to efficiently transport data across highly nested components with React Context, a powerful feature that simplifies prop drilling and improves your application's maintainability.
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 3.16
   ```sh
   git checkout 3.16
   ```
