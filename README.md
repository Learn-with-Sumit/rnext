...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/passing-props-to-a-component" target="_blank" >REACTIVE ACCELERATOR - MODULE 1 - LESSON 8</a></h3>
</p>
...
Our in-depth lesson will teach you how to send props in React components. Investigate the process for transmitting data from one component to another via props—essential for developing dynamic and reusable React apps. This lesson will lead you through practical examples of how to pass information and change component behavior.
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 1.8
   ```sh
   git checkout 1.8
   ```
