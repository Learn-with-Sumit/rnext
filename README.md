...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/responding-to-events-event-propagation" target="_blank" >REACTIVE ACCELERATOR - MODULE 2 - LESSON 2</a></h3>
</p>
...
This deep tutorial explores into the complicated nature of React event propagation. Understand how events propagate via React components and the importance of managing this flow. Learn how to stop event propagation and explore the concept of passing handlers as an alternative to propagation. Discover methods for preventing default behavior in React applications, as well as a more in-depth grasp of event handling in your projects.
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 2.2
   ```sh
   git checkout 2.2
   ```
