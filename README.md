...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/javascript-in-jsx-with-curly-braces" target="_blank" >REACTIVE ACCELERATOR - MODULE 1 - LESSON 7</a></h3>
</p>
...
Explore the use of curly braces in React by digging into the integration of JavaScript within JSX. Learn how to use JavaScript expressions directly into your JSX code to create dynamic and data-driven React components. This video shows you how to effortlessly integrate JavaScript functionality into your JSX, enabling a new level of freedom in your React apps.
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 1.7
   ```sh
   git checkout 1.7
   ```
