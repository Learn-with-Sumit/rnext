...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/extracting-state-logic-into-a-reducer-example-project" target="_blank" >REACTIVE ACCELERATOR - MODULE 3 - LESSON 12</a></h3>
</p>
...
Improve your React state management with our tutorial "Optimizing React State Management: Extracting State Logic into a Reducer." In this informative video, we walk you through the process of combining state logic with a reducer, allowing you to handle complicated state scenarios in a more streamlined and effective manner.
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 3.12
   ```sh
   git checkout 3.12
   ```
