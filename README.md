...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/reactive-accelerator-course-intro" target="_blank" >REACTIVE ACCELERATOR - MODULE 11 - LESSON 4</a></h3>
</p>
...
In this lesson, we walked through setting up a Next.js project and configuring a GraphQL client. We also covered how to write basic queries to fetch data effectively. If you'd like to practice, you can clone our repository and try implementing these steps on your own.
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 11.4
   ```sh
   git checkout 11.4
   ```
