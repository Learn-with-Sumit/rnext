...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/choosing-the-state-structure-avoid-redundant-state" target="_blank" >REACTIVE ACCELERATOR - MODULE 3 - LESSON 6</a></h3>
</p>
...
The lesson is going to highlight the importance of selecting an effective React state structure by minimizing unnecessary state variables. Learn how to simplify state management by removing unnecessary duplication and ensuring that each state variable has a distinct and useful purpose.
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 3.6
   ```sh
   git checkout 3.6
   ```
