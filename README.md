...
<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://learnwithsumit.com/rnext/courses/rnext/understanding-state-a-component-s-memory" target="_blank" >REACTIVE ACCELERATOR - MODULE 2 - LESSON 3</a></h3>
</p>
...
This informative lesson will take you on a journey into the world of React State. Learn how the concept of state in React is used to manage a component's memory. Recognize the critical role that state plays in dynamically preserving and updating component data. This course walks you through the process of exploiting React State to create more dynamic and responsive user interfaces with actual examples.
...
3. Go to the cloned project directory
   ...
   cd rnext
   ```
4. Checkout/switch to branch 2.3
   ```sh
   git checkout 2.3
   ```
